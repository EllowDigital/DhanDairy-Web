        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 max-w-3xl">
          ...
          <header className="mb-8 sm:mb-10">
            ...
            <div className="flex flex-wrap items-center gap-4 text-sm text-muted-foreground">
              ...
              <span className="flex items-center gap-1.5">
                <Calendar className="w-3.5 h-3.5" /> 18 Feb 2026
              </span>
              <span className="flex items-center gap-1.5">
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-foreground [&_h2]:heading-3 [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-4 [&_p]:text-muted-foreground [&_p]:leading-relaxed [&_li]:text-muted-foreground [&_strong]:text-foreground">
            <p>
              With hundreds of finance apps on the Play Store, finding the right
              one can be overwhelming. We tested and compared the most popular
              free finance apps for Android in 2025, focusing on what matters
              most to Indian users: privacy, offline support, and no hidden
              costs.
            </p>
            ...
            <ul className="list-disc pl-6 space-y-2">
              <li>
                <strong>Completely free</strong> — no paywalls or premium tiers
                for essential features
              </li>
              <li>
                <strong>No ads or trackers</strong> — your financial data should
                stay private
              </li>
              <li>
              ...
              <li>
                <strong>Data export</strong> — PDF, CSV, or Excel for
                record-keeping
              </li>
              <li>
                <strong>India-focused</strong> — supports INR, Indian
                categories, Hindi UI
              </li>
            </ul>
            ...
            <table className="w-full border border-border rounded-xl overflow-hidden text-sm">
              <thead>
                <tr className="bg-accent">
                  <th className="text-left p-3 font-display font-semibold text-foreground">
                    App
                  </th>
                  <th className="p-3 font-display font-semibold text-foreground text-center">
                    Offline
                  </th>
                  <th className="p-3 font-display font-semibold text-foreground text-center">
                    No Ads
              ...
              <tbody>
                {apps.map((app) => (
                  <tr
                    key={app.name}
                    className={`border-t border-border ${app.name === "DhanDiary" ? "bg-primary/5" : ""}`}
                  >
          ...
          <div className="prose prose-lg max-w-none space-y-6 text-foreground [&_h2]:heading-3 [&_h2]:text-foreground [&_h2]:mt-10 [&_h2]:mb-4 [&_p]:text-muted-foreground [&_p]:leading-relaxed [&_strong]:text-foreground">
            ...
            <p>
              DhanDiary stands out as the only app that checks every box. It's
              completely free with no ads, works entirely offline, respects your
              privacy, and supports data export in multiple formats. Built by an
              indie developer in India, it understands the needs of Indian users
              — from UPI tracking categories to INR-first design.
            </p>

            <h2>Final Verdict</h2>
            <p>
              If you're looking for a free, private, offline-capable finance app
              with no compromises, DhanDiary is the clear winner for 2025.
              Download it today and take control of your money.
            </p>
          </div>
