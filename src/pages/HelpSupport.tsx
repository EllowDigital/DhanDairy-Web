...
const guides = [
  {
    ...
    description:
      "Download, install, and set up your DhanDiary account in minutes.",
    topics: [
      "Download the app",
      "Create your account",
      "Set up categories",
  ...
  },
  {
    ...
    description:
      "Learn how to track income, expenses, and manage your finances effectively.",
    topics: [
      "Add income & expenses",
  ...
  },
  {
    ...
    description:
      "Understand how DhanDiary keeps your financial data safe and private.",
    topics: [
      "Data encryption",
      "Offline storage",
      "No tracking policy",
  ...
  },
  {
    ...
    title: "Backup & Sync",
    description:
      "Keep your data safe with cloud backup and sync across devices.",
    topics: [
      "Enable cloud backup",
      "Restore your data",
      "Sync settings",
...
const faqs = [
  {
    ...
    answer:
      "Yes, DhanDiary is 100% free with no hidden charges, no premium tiers, and no in-app purchases. All features are available to every user.",
  },
  {
    question: "Does DhanDiary work offline?",
    answer:
      "Absolutely. DhanDiary is designed offline-first. You can add transactions, view charts, and manage your finances without any internet connection. Data syncs automatically when you're back online.",
  },
  {
    question: "How is my data protected?",
    answer:
      "Your data is encrypted and stored locally on your device. We never sell or share your data. There are no ads, no trackers, and no third-party analytics. Your finances are truly private.",
  },
  {
    question: "Can I export my financial data?",
    answer:
      "Yes, you can export your data in PDF and CSV formats. Go to Settings → Export Data to generate reports for any time period.",
  },
  {
    question: "How do I reset my password?",
    answer:
      "On the login screen, tap 'Forgot Password' and enter your registered email. You'll receive a reset link within minutes. Check your spam folder if you don't see it.",
  },
  {
    question: "Which devices are supported?",
    answer:
      "DhanDiary is available for Android devices running Android 7.0 (Nougat) and above. You can download it from Samsung Galaxy Store, Amazon Appstore, Huawei AppGallery, or directly via APK.",
  },
  {
    question: "How do I contact support?",
    answer:
      "You can reach us at sarwanyadav6174@gmail.com. We typically respond within 24 hours. For faster help, include your device model and app version in your message.",
  },
  {
    question: "Can I suggest new features?",
    answer:
      "We love hearing from users! Send your feature suggestions to our email or visit our Roadmap page to see what's planned. Many features have been added based on user feedback.",
  },
];
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          ...
          >
            ...
            <p className="body-large mt-4">
              Step-by-step instructions to help you get the most out of
              DhanDiary.
            </p>
          </AnimatedSection>
