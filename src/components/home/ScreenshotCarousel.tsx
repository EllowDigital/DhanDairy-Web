...
const screenshots = [
  {
    ...
    description: "Complete view of your finances at a glance",
  },
  {
    id: 2,
    image: "/img/Screenshot/2s.jpg",
    title: "Transaction History",
    description: "Track all income and expenses with detailed logs",
  },
  {
    id: 3,
    image: "/img/Screenshot/3s.jpg",
    title: "Add Transaction",
    description: "Quick transaction entry with smart categories",
  },
  {
    id: 4,
    image: "/img/Screenshot/4s.jpg",
    title: "Charts & Analytics",
    description: "Visualize spending with beautiful charts",
  },
  {
    id: 5,
    image: "/img/Screenshot/5s.jpg",
    title: "Budget Planning",
    description: "Set and track budgets per category",
  },
  {
    id: 6,
  ...
  },
  {
    ...
    description: "Customize and secure your app",
  },
  {
    id: 9,
...
const ScreenshotCarousel = () => {
  ...
  const goTo = useCallback((dir: -1 | 1) => {
    setActiveIndex(
      (prev) => (prev + dir + screenshots.length) % screenshots.length,
    );
  }, []);
              ...
              <AnimatePresence mode="popLayout">
                {getVisible().map((index) => {
                  ...
                  return (
                    ...
                    >
                      <div
                        className={`relative bg-gradient-to-b from-zinc-800 to-zinc-900 rounded-[2rem] lg:rounded-[2.5rem] p-1.5 lg:p-2 shadow-elevated ${isActive ? "ring-2 ring-primary/15" : ""}`}
                      >
