...
const PartnersSection = () => {
    ...
    },
    {
      ...
      badge: (
        <div className="h-11 w-[160px] px-5 flex flex-col items-center justify-center bg-primary rounded-lg text-center leading-tight">
          <span className="text-[9px] text-primary-foreground uppercase tracking-wider font-medium">See All</span>
          <span className="text-sm text-primary-foreground font-bold">Download Options</span>
        </div>
      ),
    },
  ];
  ...
  return (
    <section id="download" className="section-padding relative overflow-hidden bg-section-gradient">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8 relative">
        ...
        >
          ...
          <h2 className="heading-2 text-foreground mb-4 text-balance">
            Available on <span className="text-gradient">multiple platforms</span>
          </h2>
            ...
            >
              {store.url ? (
                store.internal ? (
                  ...
                  >
                    <div className="mb-4 transform group-hover:scale-105 transition-transform duration-300">{store.badge}</div>
                    <h3 className="font-semibold text-foreground text-sm text-center">{store.name}</h3>
                  ...
                  >
                    ...
                    <div className="flex items-center gap-1 text-primary text-xs font-medium mt-2 opacity-0 group-hover:opacity-100 transition-opacity">
                      <span>Get it</span><ExternalLink className="w-3.5 h-3.5" />
                    </div>
                  </a>
                )
              ) : null}
        ...
        >
          {[
            ...
            <div key={i} className="text-center">
              <p className="font-bold text-foreground text-base lg:text-lg">{item.label}</p>
